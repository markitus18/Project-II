...
bool M_Explosion::Awake(pugi::xml_node&)
{
	...
	{
		spinSystem.PushExplosion(5.0f + t, { (int)(60 * cos(n * factor)), (int)(60 * sin(n * factor)) }, 40, 100, 1, 0.25f, PLAYER, false, EXPLOSION_BLOOD);
		t += 0.15;
	}
...
bool M_Explosion::Start()
{
	...
	bossGreen.texture = App->tex->Load("graphics/neutral/missiles/pdriphit_p.png");
