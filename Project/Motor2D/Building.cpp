...
{
	iPoint pos = FindCloseWalkableTile(2, 6);
...
iPoint Building::FindCloseWalkableTile(int correction_x, int correction_y)
{
	iPoint tile = { (int)position.x - 1 + correction_x, (int)position.y - 1 + correction_y };
