...
public:
	...
	*/
	...
	Order's button WILL be changed
	*/
	UI_Button2* setOrder(Order& toAssign, const SDL_Rect & idle, const SDL_Rect & clicked, uint row_index, uint col_index, SDL_Texture& tex,  float width = 0.0f, float height = 0.0f, SDL_Rect collider = { 0, 0, 0, 0 });
